...
export default function Hero({ 
  ...
  return (
    <div className={`relative ${height} w-full flex items-center justify-center overflow-hidden bg-white font-sans`}>
...
<div className="absolute inset-0 z-0 overflow-hidden">
  <Image
    ...
    quality={100} // Default 75 hota hai, isse 100 kardo full quality ke liye
  ...
  <div className="absolute inset-0 backdrop-blur-[2px] z-10"></div>
      ...
      <div className="relative z-10 container mx-auto px-6 text-center pt-20 pb-40 md:pb-52">
        <div className="max-w-5xl mx-auto flex flex-col items-center">
          ...
          <h1 className="mb-6 text-5xl md:text-7xl lg:text-8xl font-heading font-black text-white leading-[1.1] tracking-tighter">
            {title} <br /> 
            <span className="text-primary text-7xl md:text-9xl  italic">{italicPart}</span>
          </h1>
      ...
      <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-[0] z-20 -mb-1"> {/* `-mb-1` is important here */}
        <svg 
